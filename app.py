# RC Scanner API v2.1 - Server Watchlist + Journal
...
async def health():
    ...
    return {"status": "OK", "version": "v2.1", "news_live": True, "telegram_ready": tg_configured, "rel_vol_method": "intraday-accurate", "alerted_today": len(alerted_today)}
